<template>
    <section>
        <div class="container">
            <div class="row row-cols-sm-1 row-cols-md-1 row-cols-lg-2 g-5">
                <div class="col-12">
                    <div class="left-items">
                        <img src="../assets/img/banner/pexels-pixabay-164634.jpg">
                    </div>
                </div>
                <div class="col-12">
